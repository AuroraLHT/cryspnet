...
# doing that potentially, need funding to hold the repository (no free)

# class ModelDownload(install):
#     """Downloads models after installation if not already present."""

#     _MODELS_URL = 'https://storage.googleapis.com/hallucination/'
#     _MODEL_FILES = [
#         'pretrained_embeddings',
#         'pretrained_embeddings.wv.vectors.npy',
#         'pretrained_embeddings.trainables.syn1neg.npy',
#     ]
#     _DOWNLOAD_LOCATION = 'hallucination/learner'
...
setup(
    name='hallucination',
    version='0.1',
    description='Machine Learning Tools for Crystal Structure Prediction. Liang et al. (2019).',
    long_description=readme,
    author='Authors of Liang et al. Nature (2019)',
    author_email='auroralht@gmail.com, vstanev@umd.edu, aaron.kusne@nist.gov, takeuchi@umd.edu',
    packages=find_packages(),
    # cmdclass={
    #     'install': ModelDownload,
    # },
    install_requires=[
          requirements,
    ],
